  ...
  const projects: Project[] = [
    {
      ...
      tags: ["Next.js", "OpenAI", "TailwindCSS"],
      gradient: "from-cyan-500 to-blue-500",
      liveUrl: "https://your-ai-demo-url.com",                // <-- CHANGE
      codeUrl: "https://github.com/yourname/ai-content-repo", // <-- CHANGE
    },
    {
      ...
      gradient: "from-purple-500 to-pink-500",
      liveUrl: "https://www.loom.com/share/5b2e711c5ce54a98936620e7628028b4?sid=4a4b49da-cda4-4b93-8bd1-a29079e30399",  // <-- CHANGE
...
,
    ...
    },
    {
      ...
      tags: ["Vue.js", "D3.js", "Express"],
      gradient: "from-orange-500 to-red-500",
      liveUrl: "https://your-social-demo-url.com",            // <-- CHANGE
      codeUrl: "https://github.com/yourname/social-dashboard" // <-- CHANGE
    },
  ];
